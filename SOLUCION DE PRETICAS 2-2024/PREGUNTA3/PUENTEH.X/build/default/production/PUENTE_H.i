...
void __attribute__((picinterrupt(("")))) INT_RBI_0(void){
        if (INTCONbits.RBIF) {
            if (PORTBbits.RB4 == 0) {PORTC=0XF9;}
            if (PORTBbits.RB5 == 0) {PORTC=0XF6;}
            if (PORTBbits.RB6 == 0) {PORTC=0XF8;}
            if (PORTBbits.RB7 == 0) {PORTC=0XF1;}
        INTCONbits.RBIF = 0;
        }
}
void main(void) {
